      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link
              href="/recipes"
              className="bg-[var(--bg-primary)] text-[var(--text-secondary)] px-8 py-3 rounded-full font-semibold border-2 border-[var(--border-primary)] hover:border-orange-500 hover:text-orange-500 transition-all duration-200"
            >
              Browse Recipes
            </Link>
          </div>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-[var(--bg-primary)] p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-200">
            <div className="w-12 h-12 bg-[var(--icon-bg-orange)] rounded-full flex items-center justify-center mb-4">
            ...
            <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-2">Share Stories</h3>
          ...
          <div className="bg-[var(--bg-primary)] p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-200">
            <div className="w-12 h-12 bg-[var(--icon-bg-red)] rounded-full flex items-center justify-center mb-4">
            ...
            <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-2">Connect Family</h3>
            <p className="text-[var(--text-secondary)]">
          ...
          <div className="bg-[var(--bg-primary)] p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-200">
            <div className="w-12 h-12 bg-[var(--icon-bg-yellow)] rounded-full flex items-center justify-center mb-4">
            ...
            <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-2">Private & Public</h3>
            <p className="text-[var(--text-secondary)]">
