  ...
  const contactMethods = [
    {
      ...
      contact: 'support@familyrecipes.com',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          {contactMethods.map((method, index) => (
            <div key={index} className="bg-white rounded-lg shadow-md p-6 text-center">
              ...
              <p className="text-gray-900 font-medium mb-2">{method.contact}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-orange-500 text-white rounded-md hover:bg-orange-600 transition-colors duration-200 font-medium"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <p className="text-gray-600 mb-4">
                Follow us on social media for updates, tips, and recipe inspiration.
              </p>
